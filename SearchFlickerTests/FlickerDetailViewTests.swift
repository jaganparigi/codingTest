...
class FlickerDetailViewTests: XCTestCase {
    ...
    func testCleanDescription() {
        ...
        """
        let cleanedDescription = FlickerDetailView.cleanDescription(htmlDescription)
    ...
    func testExtractAuthorName() {
        ...
        let authorName = FlickerDetailView.extractAuthorName(from: author)
    ...
    func testFormattedDate() {
        ...
        let formattedDate = FlickerDetailView.formattedDate(from: dateString)
    ...
    func testInvalidDateFormatting() {
        ...
        let formattedDate = FlickerDetailView.formattedDate(from: invalidDateString)
